...
set firewall ipv4 name trusted-local rule 60 destination address '10.254.254.1'
set firewall ipv4 name trusted-local rule 60 protocol 'udp'
set firewall ipv4 name trusted-local rule 90 action 'accept'
set firewall ipv4 name trusted-local rule 90 description 'Rule: accept_icmp'
set firewall ipv4 name trusted-local rule 90 protocol 'icmp'
set firewall ipv4 name trusted-local rule 90 icmp type-name 'echo-request'
...
set firewall ipv4 name trusted-local rule 110 destination address '224.0.0.251'
