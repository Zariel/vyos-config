...
# set nat destination rule 201 destination address '!10.5.0.4'
...
# set nat destination rule 201 translation address '10.5.0.4'
# set nat destination rule 201 translation port '53'

set nat destination rule 202 description 'Force DNS for wireguard'
set nat destination rule 202 destination address '!10.5.0.4'
...
set nat destination rule 202 translation address '10.5.0.4'
set nat destination rule 202 translation port '53'

set nat66 destination rule 200 description 'Force DNS for IoT'
set nat66 destination rule 200 destination address '!fd74:f571:d3bd:1005::4'
...
set nat66 destination rule 200 translation address 'fd74:f571:d3bd:1005::4'
set nat66 destination rule 200 translation port '53'

set nat66 destination rule 201 description 'Force DNS for trusted'
set nat66 destination rule 201 destination address '!fd74:f571:d3bd:1005::4'
...
set nat66 destination rule 201 translation address 'fd74:f571:d3bd:1005::4'
