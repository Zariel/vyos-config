...
set nat destination rule 200 destination port '59453'
set nat destination rule 200 inbound-interface name 'eth2'
set nat destination rule 200 protocol 'tcp'
set nat destination rule 200 translation address '10.1.2.60'
set nat destination rule 200 translation port '59453'
