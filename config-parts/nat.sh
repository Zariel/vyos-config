...
set nat destination rule 304 description 'Force NTP for Wireguard Trusted'
set nat destination rule 304 destination address '!10.0.11.1'
set nat destination rule 304 destination port '123'
set nat destination rule 304 inbound-interface name 'wg01'
set nat destination rule 304 protocol 'udp'
set nat destination rule 304 translation address '10.0.11.1'
set nat destination rule 304 translation port '123'
