...
set nat destination rule 400 description 'Forward port for qbittorrent'
set nat destination rule 400 destination port '50413'
set nat destination rule 400 inbound-interface name 'eth2'
set nat destination rule 400 protocol 'tcp'
set nat destination rule 400 translation address '10.45.0.24'
set nat destination rule 400 translation port '50413'
