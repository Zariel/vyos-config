...
set service dhcp-server shared-network-name SERVERS subnet 10.1.1.0/24 static-mapping k8s-1 mac-address 'c4:65:16:19:a0:94'
...
set service dhcp-server shared-network-name TRUSTED subnet 10.1.2.0/24 static-mapping chris-iphone mac-address 'ac:49:db:32:94:c8'
...
set service dhcp-server shared-network-name K8S subnet 192.168.42.0/24 default-router '192.168.42.1'
...
set service dhcp-server shared-network-name K8S subnet 192.168.42.0/24 static-mapping k8s-0 static-mapping-parameters 'option host-name k8s-0;'
...
set service dhcp-server shared-network-name K8S subnet 192.168.42.0/24 static-mapping k8s-0 static-mapping-parameters 'option host-name k8s-1;'
...
set service dhcp-server shared-network-name K8S subnet 192.168.42.0/24 static-mapping k8s-0 static-mapping-parameters 'option host-name k8s-2;'
...
set service dhcp-server shared-network-name K8S subnet 192.168.42.0/24 static-mapping k8s-0 static-mapping-parameters 'option host-name k8s-3;'
...
set service dhcp-server shared-network-name K8S subnet 192.168.42.0/24 static-mapping k8s-0 static-mapping-parameters 'option host-name k8s-4;'
